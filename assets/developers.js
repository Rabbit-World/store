...
<head>
    <title>${name} | rabbit r1 developer</title>
	<!--
    ...
    <div id="wrap">
        ...
        <div id="main">
            ...
            <div class="header">
                ...
                <h1 class="title">${name} <i class="fa-brands fa-dev"></i> rabbit r1</h1>
			...
			<iframe width="100%" height="450" src="https://www.youtube.com/embed/RGVZ74r_YRo?si=19JveuD2GrpRAwO5" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                ...
                <table>
                    ...
                    <tbody>
                        <!--tr><td><a href="../apps/app_NAME.html" data-translatable>NAME</a></td><td>VERSION</td><td><i class="fa-solid fa-carrot"></i> <i class="fa-solid fa-carrot"></i> <i class="fa-solid fa-carrot"></i></td></tr-->
                    </tbody>
                    <tbody>
                ...
                <table>
                    ...
                    <tbody>
                        <!--tr><td><a href="../games/app_NAME.html" data-translatable>NAME</a></td><td>VERSION</td><td><i class="fa-solid fa-carrot"></i> <i class="fa-solid fa-carrot"></i> <i class="fa-solid fa-carrot"></i></td></tr-->
                    </tbody>
                    <tbody>
				...
				<!--div id="disqus_thread" style="padding:15px;"></div-->
                    <p><label for="feedback" data-translatable>Report a problem with the developer ${name}: // Segnala un problema con lo sviluppatore ${name}:</label><input id="feedback" type="text" /></p>
        ...
        <div id="sidebar">
            ...
            <div class="content">
                ...
                <ul class="nav">
                    ...
                    <li><a href="../developers/index.html" class="active"><span class="ico msg"><picture><source type="image/webp" srcset="../assets/apps/settings.webp"><img src="../assets/apps/settings.png" alt="-APP+"></picture></span><b data-translatable>Developers // Sviluppatori</b></a></li>
                    ...
                    <li><a href="../developers/index.html" target="_blank"><span class="ico msg"><picture><source type="image/webp" srcset="../assets/apps/app.webp"><img src="../assets/apps/app.png" alt="APP+"></picture></span><b data-translatable>Request your app... // Richiedi la tua app...</b></a></li-->
                </ul>
                
                <p data-translatable><center><a href="https://www.buymeacoffee.com/RabbitWorld" target="_blank"><img src="https://img.buymeacoffee.com/button-api/?text=Buy me a carrot&emoji=🥕&slug=RabbitWorld&button_colour=FFD6C2&font_colour=000000&font_family=Cookie&outline_colour=000000&coffee_colour=ffffff" /></a></center></p>
